...
<qgis version="3.16.3-Hannover" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" minScale="1e+08">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer band="1" classificationMin="270.3894958" type="singlebandpseudocolor" classificationMax="32338580" opacity="1" nodataColor="" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader labelPrecision="4" colorRampType="INTERPOLATED" minimumValue="270.3894958" classificationMode="2" clip="0" maximumValue="32338580">
          ...
          <item value="270.3894958" label="270,3895" alpha="255" color="#440154"/>
          <item value="8084847.79212185" label="8084847,7921" alpha="255" color="#3a528b"/>
          <item value="16169425.194747899" label="16169425,1947" alpha="255" color="#20908d"/>
          <item value="24254002.59737395" label="24254002,5974" alpha="255" color="#5dc962"/>
          <item value="32338580" label="32338580,0000" alpha="255" color="#fde725"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast contrast="0" gamma="1" brightness="0"/>
    <huesaturation saturation="0" colorizeGreen="128" colorizeStrength="100" colorizeOn="0" grayscaleMode="0" colorizeRed="255" colorizeBlue="128"/>
