...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" minScale="1e+08" version="3.16.3-Hannover">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" opacity="1" type="singlebandpseudocolor" classificationMin="0" classificationMax="21.9657879" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" clip="0" colorRampType="INTERPOLATED" classificationMode="1" maximumValue="21.9657879" labelPrecision="4">
          ...
          <item label="5,4914" color="#fed98e" value="5.491446975" alpha="255"/>
          <item label="10,9829" color="#fe9929" value="10.98289395" alpha="255"/>
          <item label="16,4743" color="#d95f0e" value="16.474340925" alpha="255"/>
          <item label="21,9658" color="#993404" value="21.9657879" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
